...
python ../demx.py -1 iclip_1.fq.gz -o results/bc/se -s info_iclip.csv -x 1 -l 3 -r 2 -m 0  
...
python ../demx.py -1 idx_eclip_2.fq.gz -o results/p7_bc/se -s info_idx_eclip.csv -x 1 -l 0 -r 1 -m 0 
